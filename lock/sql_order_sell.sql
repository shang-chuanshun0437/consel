...
(
    ...
    create_time VARCHAR(24) comment "订单创建日期,格式为20181015095546，表示2018-10-15 09:55:46",
    update_time VARCHAR(24) comment "订单更新日期,格式为20181015095546，表示2018-10-15 09:55:46",
